...
****************************************************************************/
/* This early unofficial LV2 extension uses double for timestamps. */
/* For alternative see the official LV2 MIDI mechanisms */

#ifndef LV2_LL_MIDITYPE_H
#define LV2_LL_MIDITYPE_H


#define LV2_LLMIDI_URI "http://ll-plugins.nongnu.org/lv2/ext/MidiPort"
